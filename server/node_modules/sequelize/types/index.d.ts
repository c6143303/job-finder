export function define(album: string, param2: {name: {allowNull: boolean; type: StringDataTypeConstructor}; id: {autoIncrement: boolean; type: IntegerDataTypeConstructor; primaryKey: boolean}}) {
